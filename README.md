...
- También se realizó un ejercicio de clasificación de partido con LASSO. Esto permite observar los bigramas que con mayor probabilidad identifican uno u otro partido: [link](https://github.com/LCaravaggio/politext/blob/main/LASSO.ipynb)
